...
<?php
        ...
        $getfield = '?q=%23coachella&count=5';
...
?>
    ...
    <div class="container">
        <div class="row" style="text-align:left;">
            <iframe src="googlemap2.html" width="90%" height=500px></iframe>
            <div id="textBox" style="text-align:center;">
                <h3>Coachella</h3>
                <p>The Coachella Valley Music and Arts Festival is an annual two-weekend, three-day music and arts festival
                held at the Empire Polo Club in Indio, California, located in the Inland Empire's Coachella Valley in the Colorado Desert.
                This year's <a href="http://www.coachella.com/lineup/" target= "_blank">lineup</a> featured 184 artists. </p>
                <p>Learn more about <a href="http://www.coachella.com/" target="_blank">Coachella</a>.</p>
            </div>
        </div>
